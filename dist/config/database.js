...
exports.dbConfig = exports.testDatabaseConnection = exports.createPool = exports.createConnection = void 0;
...
for (const u of urlCandidates) {
    if (u) {
        ...
        if (parsed) {
            exports.dbConfig = dbConfig = { ...dbConfig, ...parsed };
            break;
        }
    }
}
...
const testDatabaseConnection = async () => {
    try {
        const connection = await (0, exports.createConnection)();
